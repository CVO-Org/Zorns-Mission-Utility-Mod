...
Functions to provide Map Diary Entries, see: [addons\diary\functions\api](addons\diary\functions\api)

## Basic Entry Creation
![alt text](../../docs/img/diary_setEntry.png)
...
![alt text](../../docs/img/diary_alliedForces.png)
...
## Future Plan
- Investigate 3den Editor Modules for easier handling
