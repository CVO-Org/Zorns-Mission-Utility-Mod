[
    ...
    SETLSTRING(saveRestore_save_arsenalclosed),
                                                                    //    _title       - Display name or display name + tooltip (optional, default: same as setting name) <STRING, ARRAY>
    [LSTRING(cat_title),LSTRING(set_saveRestore_subcat_title)],         //    _category    - Category for the settings menu + optional sub-category <STRING, ARRAY>
...
[
    ...
    SETLSTRING(saveRestore_save_missionstart),
                                                                            //    _title       - Display name or display name + tooltip (optional, default: same as setting name) <STRING, ARRAY>
    [LSTRING(cat_title),LSTRING(set_saveRestore_subcat_title)],                 //    _category    - Category for the settings menu + optional sub-category <STRING, ARRAY>
...
[
    ...
    "CHECKBOX",                                             //    _settingType - Type of setting. Can be "CHECKBOX", "EDITBOX", "LIST", "SLIDER" or "COLOR" <STRING>
    SETLSTRING(saveRestore_apply_onrespawn),
