...
/*
* Author: Someone idk who lol - reworked by Zorn
*
...
if (
    getNumber (missionConfigFile >> "enableAntiFlubber") isNotEqualTo 1
    || { missionNamespace getVariable [QGVAR(enableAntiFlubber), false] isNotEqualTo true }
) exitWith {};


INFO("AntiFlubber enabled!");
