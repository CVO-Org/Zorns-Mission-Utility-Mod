class GVAR(module_registerDeliveryMode_airDropPlane): Module_F {
    // Standard object definitions:
    scope = 2;                                                                  // Editor visibility; 2 will show it in the menu, 1 will hide it.
    scopeCurator = 1;                                                           // Zeus visibility
    displayName = CSTRING(module_registerDeliveryMode_airDropPlane);                   // Name displayed in the menu
    ...
    class Attributes: AttributesBase {
        ...
        class maxCrates: Edit {
            ...
            property = "maxCrates";
            typeName = "NUMBER";
            defaultValue = 5;                           // Because this is an expression, one must have a string within a string to return a string
        };
        class cooldown: Edit {
            control = "EditShort";
        ...
        class airframe_class: Edit {
            ...
            typeName = "STRING";
            defaultValue = """C_Plane_Civil_01_F""";
        };
    ...
    class ModuleDescription: ModuleDescription {
        description = "Registers a Delivery Mode (Airdrop - Plane) to the CSC Framework. Synced connections have no effect.";
