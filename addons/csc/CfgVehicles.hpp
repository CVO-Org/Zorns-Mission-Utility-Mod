class CfgVehicles {
    ...
    class GVAR(defineCrate): Module_F {
        // Standard object definitions:
        scope = 2;                                                      // Editor visibility; 2 will show it in the menu, 1 will hide it.
        scopeCurator = 1;                                               // Zeus visibility
        displayName = CSTRING(defineCrate_displayName);                   // Name displayed in the menu
        ...
        function = QFUNC(module_defineCrate);   // Name of function triggered once conditions are met
