...
params [ "_accessPointID", "_conditionCode" ];

[
    QGVAR(accessPoint)                                          // * 0: Action name <STRING>
    ...
    ,{
        ...
        _params params [["_accessPointID", ""]];

        [_player, _target, _accessPointID] call FUNC(request_openDialog);
    }                                                           //  * 3: Statement <CODE>
    ,_conditionCode                                             //  * 4: Condition <CODE>
    ,{}                                                         //  * 5: Insert children code <CODE> (Optional)
    ,_accessPointID                                             //  * 6: Action parameters <ANY> (Optional)
